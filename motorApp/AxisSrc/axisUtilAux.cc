...
* primary axisUtil.cc file because CA and record access code cannot both
...
char ** getAxisList()
{
    ...
    status = dbFindRecordType(pdbentry,"axis");
    if (status)
        errlogPrintf("getAxisList(): No record description\n");
