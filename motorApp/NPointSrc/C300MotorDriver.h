...
class C300Axis : public asynAxisAxis
{
public:
...
private:
  C300Controller *pC_;      /**< Pointer to the asynAxisController to which this axis belongs.
...
class C300Controller : public asynAxisController {
public:
