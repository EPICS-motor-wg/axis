...
The motor flags as received from the hardware.  The MFLG bits are defined as follows:
        ...
        Bit 2: MF_SHOW_NOT_HOMED:  Show not homed in the msg str
        Bit 3: MF_HIGH_LIMIT_RO:   Controller has a valid "read only high soft limit"
        Bit 4: MF_LOW_LIMIT_RO:    Controller has a valid "read only low soft limit"
